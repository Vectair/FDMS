...
Last updated: 2026-05-28 (Europe/London, rev 17 — UPDATER-001 complete; manual in-app updater added to Admin → System Status)
...
- **Current confirmed `main`:** `b08e292 docs: update STATE after cleared V1 snag list`.
- **Working branch for updater work:** `claude/updater-manual-admin-system-status`.
- **Working tree status at handover:** clean on feature branch.
